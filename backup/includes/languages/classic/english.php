...
// categories box text in sideboxes/categories.php
  define('BOX_HEADING_CATEGORIES', 'Start Shopping!');

// manufacturers box text in sideboxes/manufacturers.php
  define('BOX_HEADING_MANUFACTURERS', 'Manufacturers');

// whats_new box text in sideboxes/whats_new.php
  define('BOX_HEADING_WHATS_NEW', 'New arrivals<br /><span>Top tip&#39;s for the beach</span>');
  define('CATEGORIES_BOX_HEADING_WHATS_NEW', 'New Products ...');

  define('BOX_HEADING_FEATURED_PRODUCTS', 'Featured products<br /><span>Have a look at the stuff we love!</span>');
...
// specials box text in sideboxes/specials.php
  define('BOX_HEADING_SPECIALS', 'Massive reductions<br /><span>Save &pound;&pound;&pound;s on travel bags</span>');
...
// javascript messages
  ...
  define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_FEATURED_PRODUCTS', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> products)');
  ...
  define('TEXT_BASE_PRICE','From: ');

  define('TEXT_CLICK_TO_ENLARGE', 'Enlarge &amp; Colours');
...
// banner_box - all
  define('BOX_HEADING_BANNER_BOX_ALL','<a href="">Book lessons online<br /><span>Interested? Click here</span></a>');
...
// Shipping Estimator
  ...
  define('CART_SHIPPING_OPTIONS_LOGIN', 'Please <a href="' . zen_href_link(FILENAME_LOGIN, '', 'SSL') . '"><span class="pseudolink">Login</span></a>, to display your personal shipping costs.');
  ...
  define('CART_SHIPPING_METHOD_TO_NOLOGIN', 'Ship to: <a href="' . zen_href_link(FILENAME_LOGIN, '', 'SSL') . '"><span class="pseudolink">Login</span></a>');
