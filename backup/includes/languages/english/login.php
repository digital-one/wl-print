...
define('HEADING_NEW_CUSTOMER', 'Registration');
...
define('TEXT_NEW_CUSTOMER_POST_INTRODUCTION_SPLIT', 'Create a Customer Profile with <strong>' . STORE_NAME . '</strong> which allows you to shop, track the status of your current orders and review your previous orders.');

define('HEADING_RETURNING_CUSTOMER', 'Welcome back, Please sign in here:');
define('HEADING_RETURNING_CUSTOMER_SPLIT', 'Welcome back');
