...
// page title
define('TITLE', 'swimbabes');

// Site Tagline
define('SITE_TAGLINE', 'swimming lessons');

// Custom Keywords
define('CUSTOM_KEYWORDS', 'swim, swimbabes, swimming, lessons');

// Home Page Only:
  define('HOME_PAGE_META_DESCRIPTION', 'This is the home page description here');
  define('HOME_PAGE_META_KEYWORDS', 'These, are, the, home, page, keywords');
...
// repeat pattern as necessary
  define('META_TAG_DESCRIPTION_EZPAGE_15','This is the ezpage page description here');
  define('META_TAG_KEYWORDS_EZPAGE_15','swim, swimbabes, swimming, lessons');
