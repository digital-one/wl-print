...
<h1 id="addressBookProcessDefaultHeading">
<?php if (isset($_GET['edit'])) { echo HEADING_TITLE_MODIFY_ENTRY; } elseif (isset($_GET['delete'])) { echo HEADING_TITLE_DELETE_ENTRY; } else { echo HEADING_TITLE_ADD_ENTRY; } ?></h1>
...
?>
<div class="alert" id="margin_T10"><?php echo DELETE_ADDRESS_DESCRIPTION; ?></div>

<address class="address_M15"><?php echo zen_address_label($_SESSION['customer_id'], $_GET['delete'], true, ' ', '<br />'); ?></address>
<br class="clearBoth" />
