...
echo '<label class="radioButtonLabel" for="gender-male">' . MALE . '</label>' . zen_draw_radio_field('gender', 'm', '', 'id="gender-male"') . (zen_not_null(ENTRY_GENDER_TEXT) ? '<span class="alert">' . ENTRY_GENDER_TEXT . '</span>': '') . '<br class="clearBoth" /><label class="radioButtonLabel" for="gender-female">' . FEMALE . '</label>' . zen_draw_radio_field('gender', 'f', '', 'id="gender-female"') . (zen_not_null(ENTRY_GENDER_TEXT) ? '<span class="alert">' . ENTRY_GENDER_TEXT . '</span>': ''); ?>
<br class="clearBoth" />
<?php
  }
?>
