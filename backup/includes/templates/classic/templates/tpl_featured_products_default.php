...
// only show button when there is something to submit
  if ($show_top_submit_button == false) {
?>
  <div class="buttonRow forward" style="display:none;"><?php echo zen_image_submit(BUTTON_IMAGE_ADD_PRODUCTS_TO_CART, BUTTON_ADD_PRODUCTS_TO_CART_ALT, 'id="submit1" name="submit1"'); ?></div>
<?php
  } // end show top button
?>
...
?>
<div class="clearBoth" style="margin:0px;padding:0px;height:0px;"></div>
...
<?php
  if ($show_bottom_submit_button == false) {
// only show button when there is something to submit
?>
  <div class="buttonRow forward" style="display:none;"><?php echo zen_image_submit(BUTTON_IMAGE_ADD_PRODUCTS_TO_CART, BUTTON_ADD_PRODUCTS_TO_CART_ALT, 'id="submit2" name="submit1"'); ?></div>
<?php
