...
<?php
  ...
  ?>
<p class="forward" id="show_all_orders"><?php echo '<a href="' . zen_href_link(FILENAME_ACCOUNT_HISTORY, '', 'SSL') . '">' . OVERVIEW_SHOW_ALL_ORDERS . '</a>'; ?></p>
<br class="clearBoth" />
<table width="426" border="0" cellpadding="0" cellspacing="0" id="prevOrders">
<caption><h2><?php echo OVERVIEW_PREVIOUS_ORDERS; ?></h2></caption>
    ...
    <th scope="col" class="total"><?php echo TABLE_HEADING_TOTAL; ?></th>
    <th scope="col" class="view"><?php echo TABLE_HEADING_VIEW; ?></th>
  </tr>
<?php
...
?>
  <tr class="order_list">
    ...
    <td width="50px" align="right"><?php echo $orders['order_total']; ?></td>
