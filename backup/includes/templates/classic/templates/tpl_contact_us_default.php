...
<div class="mainContent success"><br /><?php echo TEXT_SUCCESS; ?></div>
...
<h1 id="RegistrationDefaultHeading"><?php echo HEADING_TITLE; ?> Email Form</h1>

<fieldset id="contactUsForm">
<div class="alert forward" id="padding_T10"><?php echo FORM_REQUIRED_INFORMATION; ?></div>
<br class="clearBoth" />
...
<br class="clearBoth" />
<br class="clearBoth" />
<label for="enquiry" class="enquiry"><?php echo ENTRY_ENQUIRY . '<span class="alert">' . ENTRY_REQUIRED_SYMBOL . '</span>'; ?></label>
