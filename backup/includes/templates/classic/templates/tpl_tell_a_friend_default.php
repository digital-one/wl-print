...
<h1 id="logoffDefaultHeading"><?php echo sprintf(HEADING_TITLE, $product_info->fields['products_name']); ?></h1>
...
<br class="clearBoth" />
<br class="clearBoth" />
<label for="email-message" class="enquiry"><?php echo FORM_TITLE_FRIEND_MESSAGE; ?></label>
