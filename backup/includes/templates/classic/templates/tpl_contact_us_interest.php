 ...
 * Page Template
 *
 * Loaded automatically by index.php?main_page=contact_us_interest.<br />
...
<?php echo zen_draw_form('contact_us_interest', zen_href_link(FILENAME_CONTACT_US, 'action=send')); ?>
