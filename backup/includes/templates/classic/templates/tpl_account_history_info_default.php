...
<h1 id="logoffDefaultHeading"><?php echo HEADING_TITLE . ORDER_HEADING_DIVIDER . sprintf(HEADING_ORDER_NUMBER, $_GET['order_id']); ?></h1>

<div class="forward" id="show_all_orders"><?php echo HEADING_ORDER_DATE . ' ' . zen_date_long($order->info['date_purchased']); ?></div>
<br class="clearBoth" />

<table border="0" cellspacing="0" cellpadding="0" summary="Itemized listing of previous order, includes number ordered, items and prices" id="OrderInfo">
...
<h1 id="RegistrationDefaultHeading"><?php echo HEADING_ORDER_HISTORY; ?></h1>
...
<h1 id="RegistrationDefaultHeading"><?php echo HEADING_DELIVERY_ADDRESS; ?></h1>
<?php
...
<h1 id="RegistrationDefaultHeading"><?php echo HEADING_BILLING_ADDRESS; ?></h1>
