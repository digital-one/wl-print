...
<?php 
$cPath=$_GET['cPath'];
if ($cPath =="68") $heading_title_style = "display:none;"; 
else $heading_title_style = "";
?>

<h1 id="indexCategoriesHeading" style="<? echo $heading_title_style; ?>"><?php echo $breadcrumb->last(); ?></h1>
<?php } ?>
...
$cPath=$_GET['cPath'];
if ($cPath =="68") $heading_desc_style = "width:200px;margin-top:150px;"; 
else $heading_desc_style = "";

// categories_description
    if ($current_categories_description != '') {
?>

<div id="categoryDescription" class="catDescContent" style="<? echo $heading_desc_style; ?>"><?php echo $current_categories_description;  ?></div>
