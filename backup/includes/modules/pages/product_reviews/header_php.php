...
//  $products_image = $review->fields['products_image'];
  ...
  $reviews_query_raw = "SELECT r.reviews_id, left(rd.reviews_text, 150) as reviews_text, r.reviews_rating, r.date_added, r.customers_name, r.customers_id
  ...
  while (!$reviews->EOF) {
  	$reviewsArray[] = array('id'=>$reviews->fields['reviews_id'],
  	                        ...
  	                        'customersID'=>$reviews->fields['customers_id'],
