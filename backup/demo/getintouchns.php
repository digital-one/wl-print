...
<form action="getintouchns.php" method="post">
	<div id="left_cont">
			...
			<div class="main_image">
				<img src="images/Contact-Banner-2.jpg" alt="Shark!" style="border:0;" />
				<span></span>
			</div>
	
	
		<h3 class="page_header wwd_fix"><img src="images/navi_nsu.gif" alt="Newsletter Sign Up" style="border:0;" /><span>Newsletter Sign Up</span></h3>
