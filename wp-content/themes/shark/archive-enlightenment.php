<?php get_header() ?>
<div id="enlightenment-page" class="section enlightenment scrollable" data-anchor="gallery" data-title="<?php wp_title()?>">
...
<a href="<?php echo home_url() ?>/gallery/archive/pge/<?php echo $next_page ?>" class="button more-posts<?php if($next_page > $max_num_pages): ?> end<?php endif ?>">Load more posts</a>
</footer>
</div>
